...
class Tinder:
    ...
    def load_reg_gui(self):
        ...
        self.reg_btn = Button(self.root, text='Sign Up', bg='#ffffff', width=30, height=2,
        ...
        self.login_btn = Button(self.root, text='Login', bg='#ffffff', width=20, height=2,
    ...
    def load_others_profile_gui(self, data, index, show_propose_btn=1):
        ...
        prev = Button(frame, text="Previous", bg='#ffffff', width=10, height=1,
                      command=lambda: self.intermediate(data, index1 - 1, show_propose_btn))
        prev.pack(side=LEFT)

        if show_propose_btn == 1:
            propose = Button(frame, text="Propose", bg='#ffffff', width=10, height=1,
                             command=lambda: self.propose(data[index][0]))
        ...
        next = Button(frame, text="Next", bg='#ffffff', width=10, height=1,
                      command=lambda: self.intermediate(data, index + 1, show_propose_btn))
        next.pack(side=LEFT)
    ...
    def change_dp(self):
        ...
        #print(pathname)
        #C:\Users\Upama Dutta\PycharmProjects\tinder1\img

        shutil.copyfile(pathname,"C:\\Users\\Upama Dutta\\PycharmProjects\\tinder1\\img\\" + filename)
        #update the dp inthe database
